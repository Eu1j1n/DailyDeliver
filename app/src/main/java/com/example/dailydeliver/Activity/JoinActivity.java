    ...
    activityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
            result -> {
                if (result.getResultCode() == Activity.RESULT_OK) {
                    ...
                    YesCustomDialog dialog = new YesCustomDialog(this,
                            "동네 인증에 성공했습니다 !!",
                            new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    certificateDongNaeButton.setEnabled(false);
                                    certificateDongNaeButton.setText("동네 인증 완료");
                                    certificateDongNaeButton.setBackgroundColor(Color.parseColor("#808080"));
                                }
                            },
                            null);
                    dialog.show();
    ...
    registerButton.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (!isValidPassword(receiveCheckPassWord)) {
                Toast.makeText(JoinActivity.this, "비밀번호: 8~16자의 영문 대/소문자, 숫자, 특수문자를 사용해 주세요.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            if (!isNeighborhoodAuthenticated) {
                Toast.makeText(JoinActivity.this, "동네 인증을 완료해주세요.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    if (response.isSuccessful()) {
                        // 회원가입 성공 시 YesCustomDialog 사용
                        YesCustomDialog dialog = new YesCustomDialog(JoinActivity.this,
                                "회원가입이 성공적으로 완료되었습니다.",
                                new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
